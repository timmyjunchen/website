...
export const works: Work[] = [
  {
    ...
    category: 'Graphics',
    thumbnailUrl: '/images/works/Fire.png',
    link: '',
    description: ``,
  ...
  {
    id: 2,
    title: 'Leukemia Cell Detector',
    category: 'Machine Learning',
    thumbnailUrl: '/images/works/ResNeXt.png',
    link: '',
    description: `Developed ResNeXt Convolutional Neural Network to detect Leukemia cells from Bone Marrow Tissue Slides. 
    Presented results to researchers at Cornell Operations Research and Information Engineering Research fair.
    Utilized ResNeXt101 model on an augmented dataset from the National Cancer Institute.`,
  ...
  {
    id: 3,
    title: 'Seagull Humorous Caption Generator',
    category: 'Machine Learning',
    thumbnailUrl: '/images/works/Seagull.png',
    link: '',
    description: `Implemented large language model with 110 million trainable parameters to generate witty scene captions.
    Generated learnable latent representations and implemented multi-head attention to capture scene context.
    Finetuned Seagull from pretrained model using PyTorch based on the OpenWebText dataset.`,
    publishedAt: 'Nov 2023',
    images: ['/images/works/work-01.png', '/images/works/work-02.png', '/images/works/work-03.png'],
    previewUrl: 'https://pofology.bdlancers.com/',
    featureList: [
